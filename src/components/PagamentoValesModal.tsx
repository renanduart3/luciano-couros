...
export function PagamentoValesModal({ clienteId, clienteNome, clienteDocumento, vales, onClose, onSaved }: Props) {
  ...
  return <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-950/75 p-2 backdrop-blur-sm sm:p-4">
    <form onSubmit={registrar} role="dialog" aria-modal="true" aria-labelledby="pagamento-vales-titulo" className="flex max-h-[96vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
